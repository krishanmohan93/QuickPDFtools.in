        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
            {PDF_TOOLS.map((tool) => (
                <Link
                    key={tool.id}
                    href={tool.path}
                    className="group relative bg-white rounded-2xl p-6 shadow-md hover:shadow-2xl transition-all duration-300 border border-gray-100 hover:border-blue-200 hover:-translate-y-1"
                >
                    <div
                    ...
                    <div className="mt-4 flex items-center text-sm font-medium" style={{ color: tool.color }}>
                        <span className="group-hover:translate-x-1 transition-transform">Try it now</span>
