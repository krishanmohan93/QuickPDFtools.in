                        ...
                        <article className="prose prose-lg max-w-none">
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
                                <div className="bg-purple-50 p-6 rounded-lg border border-purple-200">
                                    <h3 className="text-xl font-semibold text-gray-900 mb-3">🐍 Python File Support</h3>
                                    <p className="text-gray-700">
                                        Convert .py files with proper syntax highlighting and code formatting for clean, readable PDFs.
                                    </p>
                                </div>
                                <div className="bg-blue-50 p-6 rounded-lg border border-blue-200">
                                    <h3 className="text-xl font-semibold text-gray-900 mb-3">📓 Jupyter Notebook Support</h3>
                                    <p className="text-gray-700">
                                ...
                                <div className="bg-orange-50 p-6 rounded-lg border border-orange-200">
                                    <h3 className="text-xl font-semibold text-gray-900 mb-3">⚡ Fast Conversion</h3>
                                    <p className="text-gray-700">
                                        Get your PDF in seconds. Optimized processing ensures quick turnaround even for large notebooks.
                                    </p>
                                </div>
                                <div className="bg-indigo-50 p-6 rounded-lg border border-indigo-200">
                                    <h3 className="text-xl font-semibold text-gray-900 mb-3">📱 Mobile Compatible</h3>
                                    <p className="text-gray-700">
